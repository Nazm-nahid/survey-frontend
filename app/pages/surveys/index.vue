          ...
          <tr v-for="s in store.surveys" :key="s.id" class="hover:bg-gray-50">
            ...
            <td class="px-4 py-2 text-center space-x-2">
              <button 
                ...
                class="bg-blue-500 text-black px-3 py-1 rounded hover:bg-blue-600 text-sm"
              >
                Edit
              </button>
              <button 
                @click="navigateTo('/surveys/' + s.id + '/submissions')" 
                class="bg-gray-500 text-black px-3 py-1 rounded hover:bg-gray-600 text-sm"
              >
                Submissions
              </button>
              <button 
                @click="navigateTo('/surveys/preview/' + s.id)" 
                class="bg-purple-500 text-black px-3 py-1 rounded hover:bg-purple-600 text-sm"
              >
                Preview
              </button>
            </td>
